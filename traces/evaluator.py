...
from traces.envs.bullet_safety_env import BulletSafetyEnv

from traces.classify.classifier import mujoco_safety_gymnasium_dict, DistributionGRU
from traces.envs.wrapper import HiddenObsNormalize, TraCeSActionScale, TraCeSUnsqueeze
from traces.models.actor import  ActorBuilderH
from traces.models.base import ActorH
from traces.models import ConstraintActorCriticH

class TraCeSEvaluator(Evaluator):
    ...
    def __load_model_and_env(
        ...
        self._env = TraCeSActionScale(self._env, device=torch.device('cpu'), low=-1.0, high=1.0)
    ...
    def evaluate(
        ...
        for episode in range(num_episodes):
            ...
            if ('PPOLagTraCeS' in self._cfgs['algo']) or ('PPOLagLearnedH' in self._cfgs['algo']):
