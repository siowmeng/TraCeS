...
import traces
from traces.common.experiment_grid import TraCeSExperimentGrid
from traces.utils.exp_grid_tools import train
...
#
#     eg = TraCeSExperimentGrid(exp_name='PPOLagTraCeSHuman_' + str(seed_start) + '-' + str(seed_end) + '_' + env_id)
#
...
if __name__ == '__main__':
    ...
    agent = traces.Agent('PPOLagTraCeSHuman', env_id)
    agent.learn()
