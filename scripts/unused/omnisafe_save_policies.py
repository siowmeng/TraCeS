...
if __name__ == '__main__':
    ...
    eg.add('logger_cfgs:save_model_freq', [1])
    if (mujoco_env != 'SafetyHalfCheetahVelocity-v1') and (mujoco_env != 'SafetySwimmerVelocity-v1'):
